...
time {
	...
	# HK21
	ap_prj_scripts_name="ap-hippokids-scripts-hk21"
	...
	# HK7
	ap_prj_name="ap-hippokids-js-hk7"
	export AP_PRJ_HK7_DIR="${AP_GH_PNP29_DIR}/${ap_prj_name}"
	rm -rf "${AP_PRJ_HK7_DIR}"
	cd "${AP_GH_PNP29_DIR}"
	git clone "https://github.com/pnphuong29/${ap_prj_name}.git"
